...
import type { CaregiverActivity } from "@/features/caregiver/types";
import { format } from "date-fns";

export function ActivityTable({ activities }: { activities?: CaregiverActivity[] } = {}) {
                ...
                {activities.length ? (
                  activities.map((item) => (
                    <TableRow key={`${item.type}-${item.id}`}>
                      <TableCell className="font-medium capitalize">{item.activity}</TableCell>
                      <TableCell>
