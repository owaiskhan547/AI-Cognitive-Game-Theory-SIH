...
const footerLinks = {
  Platform: [
    { label: "For Patients", href: "/patient/dashboard" },
    { label: "For Caregivers", href: "/caregiver/dashboard" },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
          <div className="col-span-2 sm:col-span-1">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground">AI-powered cognitive care for dementia patients.</p>
          </div>
