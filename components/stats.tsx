...
const stats = [
  { value: "50M+", label: "people affected by dementia worldwide" },
  { value: "30%", label: "cognitive improvement with regular stimulation" },
  { value: "24/7", label: "AI companion available anytime" },
]
