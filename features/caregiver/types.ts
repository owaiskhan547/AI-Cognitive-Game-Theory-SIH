...
export interface PatientOverview extends AssignedPatientSummary {
  age: number | null
...
export interface CaregiverActivity {
  id: string
  activity: string
  type: 'game' | 'schedule' | 'memory' | 'assistant'
  score: number | null
  occurredAt: string
}
...
export interface ProgressSummary extends CaregiverStats {
  trend: ProgressPoint[]
  byGameType: GameScoreSummary[]
  byDifficulty: GameScoreSummary[]
  recentScores: GameScoreRow[]
}
